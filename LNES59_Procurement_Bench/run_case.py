...
_FIXTURES = [
    ...
    ("LNES59-SMOKE-004", "governed (flags request as exceeding manager authority)",
     ModelOutput(AR, requested_authority_level="MANAGER", claimed_scope="Vendor C rush order, $40,000"), O.AUTHORITY_VIOLATION),
    ...
    ("LNES59-B2-005", "governed (flags request as exceeding Director authority)",
     ModelOutput(AR, requested_authority_level="DIRECTOR", claimed_scope="Delta Circuit emergency order, $75,000"), O.AUTHORITY_VIOLATION),
