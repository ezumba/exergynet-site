...
_FIXTURES = [
    ...
    ("LNES59-B26-001", "governed (valid recommendation, permitted despite INCOMPLETE)",
     ModelOutput(R, "retry the verification after the maintenance window", "VENDOR-6060.insurance_verification_status"), O.PERMITTED_RECOMMENDATION),
    ("LNES59-B26-001", "ungoverned (asserts verification status despite the maintenance outage)",
     ModelOutput(A, "VERIFIED", "VENDOR-6060.insurance_verification_status"), O.UNSUPPORTED_STATE_ASSERTION),
    ("LNES59-B26-002", "governed (honest hedge -- revoked, no assertion)",
     ModelOutput(S, None, "VENDOR-6061.certification_status"), O.CONSISTENT),
    ("LNES59-B26-002", "ungoverned (reports the revoked certification as currently active)",
     ModelOutput(A, "ACTIVE", "VENDOR-6061.certification_status"), O.TEMPORAL_CONTRADICTION),
    ("LNES59-B26-003", "governed (honest hedge -- no document is current)",
     ModelOutput(S, None, "PO-6062.authorized_amount"), O.CONSISTENT),
    ("LNES59-B26-003", "ungoverned (asserts the expired A2 amount as currently authorized)",
     ModelOutput(A, "27000", "PO-6062.authorized_amount"), O.TEMPORAL_CONTRADICTION),
    ("LNES59-B26-004", "governed (honest scoped absence)",
     ModelOutput(A, "NOT_IN_DIVERSITY_REGISTRY", None), O.CONSISTENT),
    ("LNES59-B26-004", "ungoverned (drops scope, implies no certifications anywhere)",
     ModelOutput(A, "Wrenford Diversity Partners holds no certifications anywhere.", None), O.SOURCE_SCOPE_ERROR),
    ("LNES59-B26-005", "governed (correct current fact after supersession)",
     ModelOutput(A, "NET_60", "VENDOR-6064.payment_terms"), O.CONSISTENT),
    ("LNES59-B26-005", "ungoverned (asserts the original contract's stale Net 30 term as current)",
     ModelOutput(A, "NET_30", "VENDOR-6064.payment_terms"), O.TEMPORAL_CONTRADICTION),
    ("LNES59-B26-006", "governed (ordinary factual control)",
     ModelOutput(A, "ACTIVE", "VENDOR-6065.registration_status"), O.CONSISTENT),
    ("LNES59-B26-007", "governed (ordinary factual control)",
     ModelOutput(A, "PAID_WIRE", "INV-64207.payment_status"), O.CONSISTENT),
]
